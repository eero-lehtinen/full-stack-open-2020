...
describe('favorite blog', () => {
	...
	test('of list with one blog is the same blog', () => {
		expect(listHelper.favoriteBlog(listWithOneBlog)).toEqual(listWithOneBlog[0])
	})

	test('of a bigger list is right', () => {
		expect(listHelper.favoriteBlog(largeBlogList)).toEqual(largeBlogList[2])
	})
})
...
describe('most blogs', () => {
	...
	test('of list with one blog is right', () => {
		const expected = {
	...
	test('of a bigger list is right', () => {
		...
		expect(listHelper.mostBlogs(largeBlogList)).toEqual(expected)
	})
})
...
describe('most likes', () => {
	...
	test('of a bigger list is right', () => {
		...
		expect(listHelper.mostLikes(largeBlogList)).toEqual(expected)
	})
})